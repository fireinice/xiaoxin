...
from transformers import AutoTokenizer, AutoModel, pipeline, T5Tokenizer, T5EncoderModel, AutoModelForSeq2SeqLM
...
class AnkhFeaturizer(ProtBertFeaturizer):
    def __init__(self, save_dir: Path = Path().absolute(), name="Ankh", per_tok=False):
        super().__init__(save_dir, name, per_tok)
